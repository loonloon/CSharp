...
namespace MusicPlayer.Helpers
{
    ...
    internal class RestClient : IDisposable
    {
        ...
        {
            _client = new HttpClient { BaseAddress = new Uri(baseUrl.EndsWith("/") ? baseUrl : baseUrl + "/") };
        ...
        {
            var response = await _client.GetStringAsync(endpoint + GetQueryString(queryString));
