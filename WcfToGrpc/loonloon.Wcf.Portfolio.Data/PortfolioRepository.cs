...
using loonloon.Wcf.Portfolio.Data.Models;

namespace loonloon.Wcf.Portfolio.Data
{
    public class PortfolioRepository : IPortfolioRepository
    {
        ...
        private static Models.Portfolio Fake(Guid traderId, int portfolioId)
        {
        ...
        private static IEnumerable<PortfolioItem> FakeItems(int portfolioId)
        {
